...
var slingshot;
 ...
 function setup() {
  ...
  slingshoe = new Slingshot(this.ball,{x:200,y:200});
...
function draw() {
  ...
  fill("pink");
  block9.display();
  text("drag the lineand release to hit the crazy boxes",600,250);
  ellipse(ball.posithion.x,ball.position.y,20);
  slingshot.display();
  drawSprites();
}
